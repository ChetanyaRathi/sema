...
> **Status (2026-07-09):** §4 (coroutines/yielding) is superseded — the cooperative scheduler + `AwaitIo` shipped a different mechanism (see `docs/plans/archive/2026-07-01-cooperative-scheduling.md`). §1–3 (public step-limit control, `register_fn_typed`, `IntoValue`/`FromValue` conversions) remain unbuilt and still relevant for embedders.
